...
interface DockerCiCdPipelineProps {
  content: MDXContent | null;
}

export default function DockerCiCdPipeline({ content }: DockerCiCdPipelineProps) {
  if (!content) {
    return (
      <>
        <Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const content = getMDXContent('docker-ci-cd-pipeline', 'tutorials/docker-setup-guides');
