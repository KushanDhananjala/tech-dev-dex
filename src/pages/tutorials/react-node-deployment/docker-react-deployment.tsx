...
interface DockerReactDeploymentProps {
  content: MDXContent | null;
}

export default function DockerReactDeployment({ content }: DockerReactDeploymentProps) {
  if (!content) {
    return (
      <>
        <SEO
...
export const getStaticProps: GetStaticProps = async () => {
  const content = getMDXContent('docker-react-deployment', 'tutorials/react-node-deployment');
