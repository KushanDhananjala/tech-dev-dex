    ...
    return (
      <>
        <SEO
          ...
          description="Master GitHub Actions for automated testing and deployment. Learn to set up CI/CD pipelines, automated testing, and deployment workflows with GitHub Actions."
          keywords={[
            'GitHub Actions',
            'CI/CD',
          ...
          type="article"
          image="/images/tutorials/git-github-tutorials/github-actions.svg"
          url="/tutorials/git-github-tutorials/github-actions-ci-cd"
  ...
  return (
    <>
      <SEO
        ...
        type="article"
        image={content.featuredImage || '/images/tutorials/git-github-tutorials/github-actions.svg'}
        url={`/tutorials/git-github-tutorials/github-actions-ci-cd`}
