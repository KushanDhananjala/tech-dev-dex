...
interface PythonFileAutomationProps {
  content: MDXContent | null;
}

export default function PythonFileAutomation({ content }: PythonFileAutomationProps) {
  if (!content) {
    return (
      <>
        <Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const content = getMDXContent('python-file-automation', 'tutorials/python-automation');
