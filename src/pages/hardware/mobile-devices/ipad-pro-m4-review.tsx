...
interface IPadProM4ReviewProps {
  content: MDXContent | null;
}

export default function IPadProM4Review({ content }: IPadProM4ReviewProps) {
  if (!content) {
    return (
      <>
        <Head>
          <title>iPad Pro M4 Review - TechDevDex</title>
          <meta name="description" content="iPad Pro M4 developer review" />
        </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const content = getMDXContent('ipad-pro-m4-review', 'hardware/mobile-devices');
