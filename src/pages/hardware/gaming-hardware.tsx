...
import { ArrowLeft, Gamepad2, Star, Clock, User, Filter, Search } from 'lucide-react';
  ...
  const reviews = [
    {
      ...
      description: "Comprehensive review of gaming keyboards that double as excellent development tools with mechanical switches and RGB lighting.",
      image: "/images/posts/gaming-keyboards.svg",
      category: "Keyboards",
      rating: 5,
      readTime: "14 min",
    ...
    },
    {
      ...
      image: "/images/posts/gaming-mice.svg",
      category: "Mice",
      rating: 4,
      readTime: "12 min",
      author: "TechDevDex Team",
    ...
    {
      slug: "gaming-headsets-review",
      title: "Gaming Headsets for Remote Work",
      description: "Best gaming headsets for developers working remotely, focusing on audio quality and comfort for long coding sessions.",
      image: "/images/posts/gaming-headsets.svg",
      category: "Audio",
      rating: 4,
      readTime: "13 min",
      author: "TechDevDex Team",
    ...
    {
      slug: "gaming-monitors-review",
      title: "Gaming Monitors for Development",
      description: "High-refresh rate gaming monitors that also excel for coding with excellent color accuracy and resolution.",
      image: "/images/posts/gaming-monitors.svg",
      category: "Monitors",
      rating: 4,
      readTime: "15 min",
      author: "TechDevDex Team",
    ...
    {
      slug: "gaming-chairs-review",
      title: "Gaming Chairs for Long Coding Sessions",
      description: "Ergonomic gaming chairs that provide comfort and support for developers during extended coding sessions.",
      image: "/images/posts/gaming-chairs.svg",
      category: "Furniture",
      rating: 4,
      readTime: "11 min",
      author: "TechDevDex Team",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Gaming hardware that doubles as excellent development equipment for programmers and tech enthusiasts
            </p>
          </div>
          ...
          >
            <Link href={`/hardware/gaming-hardware/${reviews[0].slug}`} className="block">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {reviews.map((review, idx) => (
              <motion.article
                ...
                className="group"
              >
                <Link href={`/hardware/gaming-hardware/${review.slug}`} className="block">
