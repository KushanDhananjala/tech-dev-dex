  ...
  const reviews = [
    {
      ...
      image: "/images/posts/github-copilot-review.svg",
      category: "AI Coding",
      rating: 5,
      readTime: "12 min",
    ...
    },
    {
      ...
      image: "/images/posts/codewhisperer.svg",
      category: "AI Coding",
      rating: 4,
      readTime: "10 min",
      author: "TechDevDex Team",
    ...
    },
    {
      ...
      image: "/images/posts/tabnine.svg",
    ...
    },
    {
      ...
      image: "/images/posts/cursor-editor.svg",
      category: "AI Editor",
      rating: 5,
      readTime: "14 min",
      author: "TechDevDex Team",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Honest reviews and comparisons of AI-powered development tools and coding assistants
            </p>
          </div>
          ...
          >
            <Link href={`/reviews/ai-tools-review/${reviews[0].slug}`} className="block">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {reviews.map((review, idx) => (
              <motion.article
                ...
                className="group"
              >
                <Link href={`/reviews/ai-tools-review/${review.slug}`} className="block">
