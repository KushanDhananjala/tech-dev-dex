...
export default function ZedVsVSCode({ content }: PageProps) {
  if (!content) {
    return (
      <>
        <SEO
          title="Zed vs VS Code: Which Editor Wins for Developers in 2025?"
          description="Latency, extensions, collaboration, and remote dev comparison."
          keywords={["Zed","VS Code","Editors"]}
          type="article"
          image="/images/reviews/software-reviews/vs-code-review.svg"
          url="/reviews/app-comparisons/zed-vs-vscode"
          section="Reviews"
        />
  ...
  return (
    <>
      <SEO
        ...
        type="article"
        image={content.featuredImage || '/images/reviews/software-reviews/vs-code-review.svg'}
        url="/reviews/app-comparisons/zed-vs-vscode"
...
export const getStaticProps: GetStaticProps = async () => {
  const content = getMDXContent('zed-vs-vscode', 'reviews/app-comparisons');
