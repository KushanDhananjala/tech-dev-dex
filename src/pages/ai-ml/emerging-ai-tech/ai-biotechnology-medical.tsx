...
const AIBiotechnologyMedical = ({ content }: ArticlePageProps) => {
  if (!content) {
    return (
  ...
  return (
    <>
      <SEO
        ...
        url="/ai-trending/emerging-ai-tech/ai-biotechnology-medical"
        ...
        <div className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex justify-between items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">AI Biotechnology and Medical</h1>
            </div>
          </div>
        </div>
...
export const getStaticProps: GetStaticProps = async () => {
  const content = getMDXContent('ai-biotechnology-medical', 'ai-trending/emerging-ai-tech');
...
export default AIBiotechnologyMedical;
