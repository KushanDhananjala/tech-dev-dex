...
interface CronJobsSchedulingProps {
  content: MDXContent | null;
}

export default function CronJobsScheduling({ content }: CronJobsSchedulingProps) {
  if (!content) {
    return (
      <>
        <Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const content = getMDXContent('cron-jobs-scheduling', 'productivity/automation-scripts');
