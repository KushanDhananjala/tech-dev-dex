...
import { ArrowLeft, Wrench, Star, Clock, User, Filter, Search } from 'lucide-react';
...
const DevelopmentTools = () => {
  ...
  const tutorials = [
    {
      slug: "vs-code-mastery",
      title: "VS Code: Complete Developer Setup",
      description: "Master Visual Studio Code with essential extensions, settings, and workflow optimizations for maximum productivity.",
      image: "/images/productivity/development-tools/vs-code-setup.svg",
    ...
    {
      slug: "git-workflow-advanced",
      title: "Advanced Git Workflow Techniques",
      description: "Master advanced Git techniques including branching strategies, rebasing, and collaborative workflows.",
      image: "/images/productivity/development-tools/git-advanced.svg",
    ...
    },
    {
      ...
      description: "Set up consistent development environments using Docker containers for any project or team.",
      image: "/images/productivity/development-tools/docker-dev.svg",
      category: "Containers",
      rating: 4,
      readTime: "22 min",
      author: "TechDevDex Team",
    ...
    },
    {
      ...
      title: "Terminal Productivity: Complete Setup",
      description: "Transform your terminal into a powerful development tool with shells, themes, and productivity plugins.",
      image: "/images/productivity/development-tools/terminal-setup.svg",
      category: "Terminal",
      rating: 4,
      readTime: "16 min",
      author: "TechDevDex Team",
    ...
    },
    {
      ...
      description: "Essential database tools for developers including GUI clients, query builders, and database design tools.",
      image: "/images/productivity/development-tools/db-tools.svg",
      category: "Database",
      rating: 4,
      readTime: "14 min",
      author: "TechDevDex Team",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
              Master essential development tools and productivity utilities for efficient coding
            </p>
          </div>
          ...
          >
            <Link href={`/productivity/development-tools/${tutorials[0].slug}`} className="block">
              <div className="flex flex-col lg:flex-row">
                <div className="lg:w-1/2 h-64 lg:h-auto bg-gradient-to-br from-teal-500/10 to-cyan-600/10 flex items-center justify-center p-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {tutorials.map((tutorial, idx) => (
              <motion.article
                ...
                className="group"
              >
                <Link href={`/productivity/development-tools/${tutorial.slug}`} className="block">
